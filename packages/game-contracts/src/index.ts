...
/** The sentence-mode calling convention. */
...
/**
 * Converts the legacy optional-id shape into the strict vocabulary ABI.
 * @param input Untrusted host content using the legacy shape.
 * @returns A canonical vocabulary array.
 */
...
/**
 * Converts the legacy optional-id shape into the strict sentence ABI.
 * @param input Untrusted host content using the legacy shape.
 * @returns A canonical sentence array.
 */
